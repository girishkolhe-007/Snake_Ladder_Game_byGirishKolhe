...
function baits(c,p)
{
	...
	if (Number(x) == Number(y)){
		document.getElementById(a).style.backgroundImage= "linear-gradient(to right, red , blue)";
	}
	else if(p == "p1")
	{
		document.getElementById(a).style.backgroundImage= "linear-gradient(to right, red,red)";
	}
	else
	{
		document.getElementById(a).style.backgroundImage= "linear-gradient(to right, blue,blue)";
	}
}
...
function prebaits(c1)
{
	...
	a = "gk" + String(c1);
	if (c1 == 4 | c1 == 9 | c1 == 20 | c1 == 28 | c1 == 40 | c1 == 51 | c1 == 63 | c1 == 71){
    	document.getElementById(a).style.backgroundImage= "linear-gradient(to right, white,white)";
	}
    else if (c1 == 17 | c1 == 54 | c1 == 62 | c1 == 64 | c1 == 87 | c1 == 93 | c1 == 95 | c1 == 99){
        ...
        document.getElementById(a).style.backgroundImage= "linear-gradient(to right, green,green)";
    }
    else{
